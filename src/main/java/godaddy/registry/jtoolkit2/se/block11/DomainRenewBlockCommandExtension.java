...
public class DomainRenewBlockCommandExtension implements CommandExtension {
    ...
    public void addToCommand(Command command) {
        ...
        final Element renewElement = xmlWriter.appendChild(extensionElement, "renew", BLOCKV11.getURI());
        if (id != null) {
            xmlWriter.appendChild(renewElement, "id", BLOCKV11.getURI()).setTextContent(id);
        }
    }
