...
/**
 * <p>Extension for the EPP Domain Create command, representing the Transfer Block aspects of the Block extension.</p>
 *
 * <p>Use this to identify the block client assigned id that this command is being submitted
 * in as part of an EPP Domain Transfer command compliant with RFC5730 and RFC5731. The response expected from a
 ...
 */
public class DomainTransferBlockCommandExtension implements CommandExtension {
    ...
    public void addToCommand(Command command) {
        ...
        final Element createElement = xmlWriter.appendChild(extensionElement, "transfer", BLOCKV11.getURI());
        if (id != null) {
