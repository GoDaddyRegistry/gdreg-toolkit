 ...
 */
public final class DomainRenewFeeResponseExtension extends FeeTransformResultType {

    private static final long serialVersionUID = -6007874008986690757L;

    public DomainRenewFeeResponseExtension() {
        super(RENEW);
    }
    ...
    public BigDecimal getRegistrationFee(String feeDescription) {
        return getFeeType().get(feeDescription).getFee();
    }
