...
import godaddy.registry.jtoolkit2.session.FactoryConfigurationError;
...
public final class HandlerFactory {
     ...
     * the system property godaddy.registry.jtoolkit2.errhandler.class to the
    ...
    public static DefaultHandler newInstance()
        ...
        String handlerClass = System.getProperty(
                "godaddy.registry.jtoolkit2.errhandler.class");
