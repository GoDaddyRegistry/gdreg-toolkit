...
public class DomainApplicationFeeCommandExtensionTest {
    ...
    public void shouldCreateValidXmlWhenSupplyFeeExtensionAndRequireXmlNamespacePrefix() throws SAXException {
        ...
        String expectedXml = "<?xml version=\"1.0\" encoding=\"UTF-8\"?>"
                ...
                + "</e:create>"
                + "<e:extension>"
                + "<feeV1_0:create xmlns:feeV1_0=\"urn:ietf:params:xml:ns:epp:fee-1.0\">"
                + "<feeV1_0:currency>USD</feeV1_0:currency>"
                + "<feeV1_0:fee description=\"Application Fee\">10.00</feeV1_0:fee>"
                + "<feeV1_0:fee description=\"Allocation Fee\">15.00</feeV1_0:fee>"
                + "<feeV1_0:fee description=\"Registration Fee\">30.00</feeV1_0:fee>"
                + "</feeV1_0:create>"
                + "</e:extension>"
