...
public class DomainRenewFeeResponseExtensionTest {
    ...
    public void shouldGetFeeExtension() throws Exception {
        ...
        final DomainRenewFeeResponseExtension feeResponseExtension = new DomainRenewFeeResponseExtension();
        ...
        assertEquals("5.00", feeResponseExtension.getRegistrationFee().toPlainString());
    }
