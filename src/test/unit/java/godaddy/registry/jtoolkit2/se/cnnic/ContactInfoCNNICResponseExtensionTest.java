...
import godaddy.registry.jtoolkit2.se.ContactInfoResponse;
...
public class ContactInfoCNNICResponseExtensionTest {
    ...
    public void setUp() throws Exception {
        ...
        cnContact.setContactTypeName("testid");
    ...
    @Test
    public void testGetCNContact() {
        assertEquals(cnContact, contactInfoCNNICResponseExtension.getCNContactDTO());
    }
