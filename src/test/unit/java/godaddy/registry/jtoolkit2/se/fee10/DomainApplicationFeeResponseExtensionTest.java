...
public class DomainApplicationFeeResponseExtensionTest {
    ...
    public void shouldGetFeeExtension() throws Exception {
        ...
        assertEquals("10.00", feeResponseExtension.getFee("Application Fee").toPlainString());
        assertEquals("15.00", feeResponseExtension.getFee("Allocation Fee").toPlainString());
        assertEquals("30.00", feeResponseExtension.getFee("Registration Fee").toPlainString());
    ...
    public void shouldNotGetFeeExtension() throws Exception {
        ...
        final DomainCreateFeeResponseExtension feeResponseExtension =
                new DomainCreateFeeResponseExtension();
    ...
    private static String getCreateResponseExpectedXml(final String domainName, boolean feeExtension) {
        ...
        if (feeExtension) {
            ...
            result.append("<fee:creData xmlns:fee=\"urn:ietf:params:xml:ns:epp:fee-1.0\">");
