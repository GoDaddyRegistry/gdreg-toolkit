...
public class MzbTransferQueryCommandTest {
    ...
    @Test
    public void testMzbTransferQueryCommandWithRoidAndPassword() {
        Command cmd = new MzbTransferQueryCommand("roid-roid", "jtkUt3st");
        try {
