...
public class DomainCreateFeeCommandExtensionTest {
    ...
    @Test
    public void shouldCreateValidXmlWhenSupplyFeeExtensionWithoutDesc() throws SAXException {

        final Command cmd = new DomainCreateCommand("jtkutest.com.au", "jtkUT3st");
        final DomainCreateFeeCommandExtension ext =
                new DomainCreateFeeCommandExtension(BigDecimal.valueOf(30.00), "USD", false);
