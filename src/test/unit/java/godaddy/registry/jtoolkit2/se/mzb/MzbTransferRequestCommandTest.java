...
public class MzbTransferRequestCommandTest {
    ...
    @Test
    public void testMzbTransferRequestCommandWithRoidAndPassword() {
        Command cmd = new MzbTransferRequestCommand("roid-roid", "jtkUt3st");
        try {
